...
export const bookPackageEmailTemplate = ({ name, packages, }) => {
                   ...
                   <tr>
                    <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                     <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                       ...
                       <tr>
                        <td align="center" class="es-m-p0r es-m-p0l es-text-4574" style="Margin:0;padding-top:10px;padding-bottom:10px;padding-right:40px;padding-left:40px"><p align="center" style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px !important;letter-spacing:0;color:#333333;font-size:14px"><em>Greetings <b>${name}</b>, Thank you for choosing <b>${packages}</b>. We're thrilled to hear about your interest in hosting an event with us. We're excited about the opportunity to potentially work together to make your event a memorable one.</em></p></td>
                       </tr>
                       <tr>
...
export const bookVendorEmailTemplate = ({ username, lastName, company }) => {
  // const previewText = `Join ${invitedByUsername} on Vercel`;
...
export const foxAdminEmailTemplate = (data, type) => {
